...
//		jdbcHelper.setCurrentDb(currentDb);
		...
		List<ColumnModel> list= jdbcHelper.queryForList(sql, map, new MySqlColumnMap());
...
//		jdbcHelper.setCurrentDb(currentDb);
		jdbcHelper=JdbcHelper.getInstance();
		List<ColumnModel> columnModels= jdbcHelper.queryForList(sql, new HashMap<String,Object>(), new MySqlColumnMap());

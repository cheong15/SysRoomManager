...
public class NodeCache {
	...
	public static Map<String, FlowNode> getSubInnerProFlowNode(Map<String, FlowNode> map, String nodeId, String nodeName, String nodeType, boolean isMultiInstance, Element nodeEl){

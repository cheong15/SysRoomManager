...
//		BpmSubtableRights bpmSubtableRights1=getFormObject(request);
		try{
			...
			BpmSubtableRights bpmSubtableRights2 = 
					bpmSubtableRightsService.getByDefIdAndNodeId(
...
//		writeResultMessage(response.getWriter(),message,ResultMessage.Success);
	...
	public void get(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		BpmSubtableRights bpmSubtableRights = bpmSubtableRightsService.getByDefIdAndNodeId(actdefid, nodeid, tableid);

...
public class BpmGangedSetController extends BaseController
{
	...
	{	
		...
		List<BpmNodeSet> nodeList = bpmNodeSetService.getByDefId(defId);
		BpmNodeSet globalNodeSet = bpmNodeSetService.getBySetType(defId,BpmNodeSet.SetType_GloabalForm);

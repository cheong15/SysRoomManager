...
public class ResourcesDao extends BaseDao<Resources>
{
	...
	public List<Resources> queryforList(String sql){
		List<Resources> list = this.jdbcTemplate.queryForList(sql, Resources.class);
		return list;
	}
...
//	}
	...
	public Resources getByAlias(String alias){
		...
		String getStatement= getIbatisMapperNamespace() + ".getByAlias";
		Resources resources = (Resources) getSqlSessionTemplate().selectOne(getStatement, alias);
		return resources;
	}
}
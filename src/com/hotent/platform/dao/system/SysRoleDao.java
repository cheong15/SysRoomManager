...
public class SysRoleDao extends BaseDao<SysRole>
{
	...
	public List<SysRole> getPartRole(List<String> list){
		String getStatement= getIbatisMapperNamespace() + ".getPartRole";
		List<SysRole> rolelist= getSqlSessionTemplate().selectList(getStatement,list);
		return rolelist;
	}

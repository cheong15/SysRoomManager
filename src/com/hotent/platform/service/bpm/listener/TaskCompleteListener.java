...
public class TaskCompleteListener extends BaseTaskListener {
	...
	HistoryActivityDao historyActivityDao=(HistoryActivityDao)AppUtil.getBean(HistoryActivityDao.class);
	private CalendarAssignService calendarAssignService=(CalendarAssignService)AppUtil.getBean(CalendarAssignService.class);

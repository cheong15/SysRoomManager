...
public class BpmPrintTemplateService extends BaseService<BpmPrintTemplate>
{
	...
	public int getCountByFormKey(Long formKey) {
	...
	public BpmPrintTemplate getDefaultByFormKey(Long formKey) {
...
//		}
	 ...
	 * 获取默认的打印模板
	 */
	public BpmPrintTemplate getDefaultPrintTemplateByFormKey(Long formKey) {

...
public class UserRoleService extends BaseService<UserRole> {
	...
	public List<String> getRoleName(){
		String userId = String.valueOf(ContextUtil.getCurrentUserId());
		if(StringUtil.isEmpty(userId)){
			logger.error("current user is not login or userId is empty.");
			return null;
		}
		List<UserRole> roleList = userRoleDao.getByUserId(ContextUtil.getCurrentUserId());
		//获取角色名

...
public class SealRightService extends BaseService<SealRight>
{
	 ...
	 * @return
	 */
	public void saveSealRight(Long sealId,String rightType,String rightIds,String rightNames,Long userId){
		//删除原来的印章权限
		this.delBySealId(sealId);
		//保存新的印章权限
		Date date = new Date();
	 ...
	 * @return
	 */
	public Map getSealRight(Long sealId) {
		Map rightMap = new HashMap();
		List<SealRight> rightList = getRightBySealId(sealId);
		String rightIds ="";
		String rightNames ="";
	...
	public int delBySealId(Long sealId) {
		return sealRightDao.delBySealId(sealId);
	}
	...
	public List<SealRight> getRightBySealId(Long sealId){
		...
		list = sealRightDao.getRightBySealId(sealId);
		return list;
	}

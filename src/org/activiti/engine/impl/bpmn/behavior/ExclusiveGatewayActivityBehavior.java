...
//        throw new ActivitiInclusiveGateWayException("分支网关没有找到合适d'"
//              + execution.getActivity().getId() + "' could be selected for continuing the process");
    	  throw new ActivitiInclusiveGateWayException("分支网关【"+execution.getActivity().getProperty("name") +"】没有符合条件的跳转,请修改流程定义的网关条件配置!");
      }
    }
  }

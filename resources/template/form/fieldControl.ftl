...
<#macro input field>
		<#if field.fieldType == "varchar"><#---字符串类型-->
			<#switch field.controlType>
				...
				<#break>
				<#case 4><#--人员选择器(单选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="user" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" showCurUser="<#if (field.getPropertyMap().showCurUser==null)>0<#else>${field.getPropertyMap().showCurUser}</#if>" />
				<#break>
				<#case 5><#--角色选择器(多选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="roles" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" />
				<#break>
				<#case 6><#--组织选择器(多选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="orgs" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" />
				<#break>
				<#case 7><#--岗位选择器(多选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="positions" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" />
				<#break>
				<#case 8><#--人员选择器(多选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="users" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" />
				<#break>
				<#case 9><#--文件上传-->
						<div  name="div_attachment_container"  >
							...
							<a href="javascript:;" field="${field.fieldName}" class="link selectFile" onclick="{<#if field.getPropertyMap().isDirectUpLoad==1>AttachMent.directUpLoadFile(this);<#else>AttachMent.addFile(this);</#if>}" validate="{<#if field.isRequired == 1>required:true</#if>}">选择</a>
						</div>	
				<#break>
				...
				<#break>
				<#case 17><#--角色选择器(单选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="role" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly" />
				<#break>
				<#case 18><#---组织选择器(单选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="org" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly"  showCurOrg="<#if (field.getPropertyMap().showCurOrg==null)>0<#else>${field.getPropertyMap().showCurOrg}</#if>" />
				<#break>
				<#case 19><#--岗位选择器(单选)-->
						<input name="${field.fieldName}" type="text" ctlType="selector" class="position" lablename="${field.fieldDesc}"  value="" validate="{empty:false<#if field.isRequired == 1>,required:true</#if><#if field.isWebSign == 1>,isWebSign:true</#if>}" readonly="readonly"  showCurPos="<#if (field.getPropertyMap().showCurPos==null)>0<#else>${field.getPropertyMap().showCurPos}</#if>" />
				<#break>
				<#case 20><#--流程引用-->
						<div>
							...
							<a href="javascript:;" class="link actInsts" name="${field.fieldName}">选择</a>
							<a href="javascript:;" class="link reset" name="${field.fieldName}" >重置</a>
						</div>
				<#break>
				<#case 21><#--WebSign签章控件-->
				...
				<#case 22><#--图片展示控件-->
						<div id="div_${field.fieldName?replace(":","_")}" style="width:400px;height:340px" class="pictureShow-div" > 
					        ...
					        <table id="pictureShow_${field.fieldName?replace(":","_")}_Toolbar">
					           <tr>
				                 <td width="80">
				                 	<a href="javascript:;" field="${field.fieldName}" class="link selectFile" onclick="{PictureShowPlugin.upLoadPictureFile(this);}">上传图片</a> 
				                 </td>
				                 <td width="80">
				                 	<a href="javascript:;" field="${field.fieldName}" class="link del" onclick="{PictureShowPlugin.deletePictureFile(this);}">删除图片</a> 				              
				                 </td>
				               </tr>
				            </table>   
					    </div>

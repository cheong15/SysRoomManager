		...
		<div class="hide-panel">
			<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							<div class="group">
								<a class="link save" id="dataFormSave" href="#"><span></span>添加</a>
							</div>
							<div class="group">
									...
									<tr class="editable-tr">
					                        ...
					                        <td>
					                            <div class="editable-right-div">
					                                <a href="#" class="moveup" title="上移" tabindex="-1">上移</a>
					                                <a href="#" class="movedown" title="下移"  tabindex="-1">下移</a>
					                                <a href="#" class="del"  title="移除" tabindex="-1">移除</a>
					                            </div>
					                        </td>
					                    </tr>
									</tbody>

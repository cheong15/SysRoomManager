...
<script type="text/javascript">
	...
	function handSave(generate){
			...
			//
			$.post("saveTable.ht",{table:tableJson,fields:fieldJson,generator:generate},showResponse);
	}
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group generate hidden"><a class="link table" href="#"><span></span>生成表</a></div>
				</div>
			</div>
		</div>
		</div>

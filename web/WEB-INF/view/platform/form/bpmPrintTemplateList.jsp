		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link add" href="#" onclick="editForm('${formKey}')"><span></span>添加</a></div>
					<div class="l-bar-separator"></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmPrintTemplateList" id="bpmPrintTemplateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column titleKey="管理" media="html" style="width:220px">
					<a href="#" onclick="editForm('${formKey}','${bpmPrintTemplateItem.id}')" class="link edit"><span></span>编辑</a>
					<a href="#" onclick="preview(${bpmPrintTemplateItem.id});" class="link preview"><span></span>预览</a>

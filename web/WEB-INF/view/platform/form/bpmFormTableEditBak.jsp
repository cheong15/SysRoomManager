...
<script type="text/javascript" src="${ctx}/js/hotent/platform/form/formTable.js" ></script>
<script type="text/javascript">
	var tableManager;
	$(function ()
	{
		var layout = $("#layout1").ligerLayout({allowTopCollapse: false, topHeight:100, allowTopResize: false, bottomHeight: 180, isBottomCollapse: true});
		$.post('getTableByTableId.ht?tableId=${tableId}', function(data) {
		...
		if(tableManager.validate()) {
			...
			$.post(url, data, function(data) {
				...
				if(obj.isSuccess()){//成功
			    	...
			    	$.ligerDialog.err('出错信息',"保存表失败",obj.getMessage());
			    }
			});
		} else {
...
<body>
	<div class="panel-top">
		<div class="tbar-title">
			<span class="tbar-label">编辑表</span>
		</div>
	...
	<div id="layout1">
			...
			<form id="table">
				...
				<table cellpadding="0" cellspacing="0" border="0" style="margin: 4px 30px;">
					<tr>
						...
						<td id="mainTableId" style="display:none">
							&nbsp;&nbsp;&nbsp;所属主表:&nbsp;
							<select name="mainTableId">
		...
		<div id="center" position="center" title="字段列表" style="position:relative;overflow:auto;">
			<div class="panel-top" style="position: fixed;">
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group"><a id="addField" class="link add"><span></span>增加字段</a></div>
						<div class="l-bar-separator"></div>
				...
				<div class="panel-data">
				    <table id="fieldList" cellpadding="1" cellspacing="1" class="table-grid">
						<tr>
							...
							<th width="10%" name="isFlowVar">是否流程变量</th>
						</tr>
					</table>
				</div>
					...
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td><input type="text" name="fieldName" value="" class="inputText"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td width=100>选项:</td>
									<td>
										<p><span style="display:inline-block"><input name="isRequired" type="checkbox" value="1"/>&nbsp;必填&nbsp;</span>
										<span style="display:inline-block"><input name="isList" type="checkbox" value="1"/>&nbsp;显示到列表&nbsp;</span></p>
										<p><span style="display:inline-block"><input name="isQuery" type="checkbox" value="1"/>&nbsp;作为查询条件&nbsp;</span>
										<span style="display:inline-block"><input name="isFlowVar" type="checkbox" value="1"/>&nbsp;是否流程变量&nbsp;</span></p>
									</td>
								</tr>
							</table>
						</td>
						<td valign="top">
							<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									<td width=100>流水号:</td>
									<td><select id="identity" name="identity"></select></td>
								</tr>
							</table>
						</td>
					</tr>

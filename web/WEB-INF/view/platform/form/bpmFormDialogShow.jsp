		...
		<c:when test="${bpmFormDialog.style==1}">
			...
			<script type="text/javascript">
				...
				function  zTreeOnClick(event, treeId, treeNode) {
					if(!isMuliti){
						parent.__resultData__=getResult();
					}
				};
				...
				function zTreeOnAsyncError(treeId,treeNode) {
					$.ligerDialog.error($lang.tip.errorMsg,$lang.tip.msg);
				};
				...
				<div class="panel-top">
					<c:if test="${fn:length(bpmFormDialog.conditionList)>0}">
						...
						<div class="panel-search">
								<form id="searchForm" method="post" action="show.ht">
										<ul class="row">

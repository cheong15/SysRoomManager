			...
			if(obj.isSuccess()){//成功
				$.ligerDialog.success(obj.getMessage(),'提示信息',function(){
					...
					if(window.opener){
						...
						else if(window.opener.location.reload){
				...
				<form id="bpmFormDefForm" action="designEdit.ht" method="post">
					<table cellpadding="0" cellspacing="0" border="0" style=" margin-bottom:4px;" >
						<tr style="height:25px;">
							...
							<td style="padding: 2px;">表注释:&nbsp;<input id="tableComment" type="text" name="tableComment" value="${tableComment}" class="inputText longInputText" onblur="getKeyName(this)"/></td>

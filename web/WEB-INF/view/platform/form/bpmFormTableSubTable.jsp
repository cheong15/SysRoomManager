...
<script type="text/javascript">
	...
	function openWin(title, target) {
		...
		var p={width:width,height:height,left:left,top:top,title:title,showMax:true,showToggle:true,
	...
	<div class="hide-panel">
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a href="#" class=" bar-button" onclick="selectSubTable()"><span></span>添加子表</a></div>

...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				initData();
				loadTree();
				$("#roleFrame").attr("src","${ctx}/platform/system/sysRole/selector.ht?isSingle=${isSingle}");
			});
			//展开收起
			...
			function treeClick(event, treeId, treeNode){
        		var url="${ctx}/platform/system/sysRole/selector.ht?Q_systemId_L="+getSelectNode() +"&isSingle=${isSingle}";
	...
	<body >
		...
		<div position="bottom"  class="bottom" style="margin-top:10px;" >
				...
				<a href="#" class="button"  onclick="window.close()" style="margin-left:10px;" ><span class="icon cancel" ></span><span class="chosen" >取消</span></a>

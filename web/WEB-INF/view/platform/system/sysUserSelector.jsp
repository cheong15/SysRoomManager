...
<div  class="panel-top">
	<div class="panel-search">
		<form id="searchForm" method="post" action="${ctx}/platform/system/sysUser/selector.ht" >
			<ul class="row">
				...
				&nbsp;<a href="#" onclick="$('#searchForm').submit()" class='button'><span>查询</span></a></li>
			</ul>
		</form>
	</div>
</div>
	...
	<display:table  name="sysUserList" id="sysUserItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
		...
		<display:column  style="width:60px;" property="userId" title="工号" sortable="true" sortName="userId"></display:column>
		<display:column  style="width:60px;" property="account" title="帐号" sortable="true" sortName="account"></display:column>

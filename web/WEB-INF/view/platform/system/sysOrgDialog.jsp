...
<script type="text/javascript">
		...
		function treeClick(event, treeId, treeNode) {
			...
			var demId = $("#demensionId").val();
			var url = "${ctx}/platform/system/sysOrg/selector.ht?orgId=" + orgId + "&demId=" + demId+"&isSingle=${param.isSingle}";
		...
		function selectOrg() {
			var pleaseSelect= $lang_selector.sysOrg.pleaseSelect;
			var aryOrg;
				if(isSingle=='true'){
	...
	<div id="defLayout">
		...
		<div position="center">
			...
			<iframe id="orgFrame" name="orgFrame" height="95%" width="100%"
				frameborder="0" src="${ctx}/platform/system/sysOrg/selector.ht?isSingle=${param.isSingle}"></iframe>
		</div>
	 ...
	 <div position="bottom"  class="bottom" style='margin-top:10px;'>
		...
		<a href="#" class="button"  onclick="clearOrg()"><span class="icon cancel" ></span><span class="cance" >清空</span></a>

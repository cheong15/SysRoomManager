		...
		<div class="panel-body">
			   <display:table name="sysTemplateList" id="sysTemplateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">											
				...
				<display:column titleKey="选择器">
					<a href="#" onclick="selectTemplate.call(this,'inner')" class="link edit">站内消息内容</a><br>
					<span name="inner" class="text">${sysTemplateItem.innerContent}</span><br>
					<a href="#" onclick="selectTemplate.call(this,'mail')" class="link edit">邮件内容</a><br>
					<span name="mail" class="text">${sysTemplateItem.mailContent}</span><br>
					<a href="#" onclick="selectTemplate.call(this,'sms')" class="link edit">短信内容</a><br>
					<span name="sms" class="text">${sysTemplateItem.smsContent}</span>
				</display:column>
			</display:table>
		</div>			
	</div>

...
<script type="text/javascript">
	...
	//var conf={url:url,onClick:treeClick,onRightClick:zTreeOnRightClick};
	...
	function treeClick(treeNode) {
		...
		var url = "${ctx}/platform/system/reportTemplate/list.ht";
		if(parentId!=null){
			url += "?typeId=" + typeId;
		}
...
<body>
    ...
    <div id="defLayout" >
		...
		<div position="center" title="报表管理">
			<iframe id="reportFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/system/reportTemplate/list.ht"></iframe>
		</div>
     </div>

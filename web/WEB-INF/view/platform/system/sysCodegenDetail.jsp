	...
	<div class="panel">
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link run" id="dataFormSave" href="#"><span></span>生成</a></div>
				</div>
			</div>
		</div>
		...
		<div id="codeDetail" style="bottom: 1; top: 1">
			<div position="top">
				<ul class="row">
					<li class="shortLi"><span class="label">是否覆盖原有文件:</span><input type="checkbox" name="override" value="1" /></li>
					<li><span class="label">流程定义:</span><input type="text" id="flowName" name="flowName" readonly="readonly"  class="inputText" value="" /><input type="button" value="..." onclick="selectFlow()"/>
						<input type="hidden" name="defKey" id="defKey" value=""/>
					</li>
					<li><span class="label">项目路径:</span><input type="text" class="inputText" name="baseDir" value="" validate="{required:true}"/></li>
				</ul>
				<ul class="row">
					<li class="shortLi"><span class="label">是否打包生成文件:</span><input type="checkbox" id="isZip" name="isZip" value="1" /></li>
					<li><span class="label">打包文件存放路径:</span><input type="text" class="inputText"  id="folderPath" name="folderPath" value="" /></li>
					<li><span class="label">模块名称:</span><input type="text" class="inputText" name="system" value="" validate="{required:true}" /></li>
				</ul>
			</div>
			<div position="left" title="代码生成器模版" id="tempalteManage" style="top: 45">

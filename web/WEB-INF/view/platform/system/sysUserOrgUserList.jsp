       ...
       <c:choose>
	       		...
	       		<div class="panel-toolbar">
					<div class="toolBar">
						...
						<c:if test="${action=='global'}">
							<div class="group"><a class="link add"  href="${ctx}/platform/system/sysUser/edit.ht?orgId=${orgId}"><span></span>新增人员</a></div>
							<div class="l-bar-separator"></div>
						</c:if>
						<div class="group"><a class="link add"  href="#" onclick="addClick()"><span></span>加入人员</a></div>
						<div class="l-bar-separator"></div>
			...
			<div class="panel-body">
				    ...
				    <display:table name="sysOrgUserList" id="sysOrgItem"  requestURI="userList.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
						...
						<display:column property="posName" title="岗位" sortable="true" sortName="posName"></display:column>
						...
						<display:column   title="管理员" >
 						...
 						<display:column title="管理" media="html" style="width:50px;text-align:center" class="rowOps">
							...
							<a href="${ctx}/platform/system/sysUser/get.ht?userId=${sysOrgItem.userId}&canReturn=0" class="link detail">明细</a>
							<c:choose>
							...
							<c:choose>
									<c:when test="${sysOrgItem.isCharge==0}">
										<a class="link charge" id="charge" title="设为负责人" href="setIsCharge.ht?userPosId=${sysOrgItem.userOrgId}">设置为负责人</a>
									</c:when>
									<c:otherwise>
										<a class="link noCharge" id="noCharge" title="设为非负责人" href="setIsCharge.ht?userPosId=${sysOrgItem.userOrgId}">设置为非负责人</a>
									</c:otherwise>
							</c:choose>

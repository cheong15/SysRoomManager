	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a id="editRebuildJob" class="link add" href="#" onclick="editRebuildJob()"><span></span>创建计划</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a id="indexSearch" class="link search" href="#"><span></span>查询</a></div>
				</div>	
			</div>
		</div>

...
<%@page import="com.hotent.platform.dao.ExtFailureAnaReportDao"%>
...
<table class="formTable" border="1" cellpadding="2" cellspacing="0">
 <tbody>
  ...
  <tr>
   ...
   <td style="width:10%" class="formTitle" align="right"> 1L</td>
   <td style="width:30%" class="formTitle"><%=si.getMyLeader(1L) %></td>
   <td style="width:10%" class="formTitle" > √</td>
  </tr>
   ...
   <td style="width:10%" class="formTitle" align="right"> 1L</td>
   <td style="width:30%" class="formTitle"><%=si.getMyUnderUserId(1L) %></td>
   <td style="width:10%" class="formTitle" > √</td>
  </tr>
 </tbody>
</table>

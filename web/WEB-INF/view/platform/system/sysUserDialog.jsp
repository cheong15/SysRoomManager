...
<body>
	<div id="defLayout" style="height:100%;">
		...
		<div position="center">
			...
			<iframe id="userListFrame" name="userListFrame" height="95%" width="100%" frameborder="0" src="${ctx}/platform/system/sysUser/selector.ht?isSingle=${isSingle}"></iframe>
		</div>
	...
	<div position="bottom"  class="bottom" style="margin-top:10px;">
		...
		<a href="#" class="button"  onclick="clearUser()"><span class="icon cancel" ></span><span class="chosen" >清空</span></a>

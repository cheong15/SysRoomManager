...
<body> 
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group">
					<a class="link save" id="save" href="#" onclick="save()"><span></span>保存布局</a>  
				</div>
				<div class="l-bar-separator"></div>				
				<div class="group">
					<a class="link back" href="../desktopMycolumn/show.ht"><span></span>返回</a>
				</div>
				<div class="l-bar-separator"></div>				
				<div class="group">
					<a class="link undo" href="../desktopMycolumn/news.ht?id=${desktopLayoutmap.id}"><span></span>重置布局</a>
				</div>
				<div class="l-bar-separator"></div>	
				<div class="group">

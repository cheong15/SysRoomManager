	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link init"  href="#" onclick="initAll('${bpmDefinition.defId}');"><span></span>初始化全部按钮</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link del" href="#" onclick="clearAll('${bpmDefinition.defId}')"><span></span>清除按钮配置</a></div>
				</div>
			</div>
		</div>
		</div>
								...
								<td>
									<c:choose>
										...
										<c:otherwise>
											...
											<a class="link init" href="#" onclick="init('${bpmDefinition.defId}','${item.nodeId}')">初始化</a>
											<a  class="link del" href="#" onclick="del('${bpmDefinition.defId}','${item.nodeId}')">删除</a>
										</c:otherwise>
									</c:choose>
								</td>

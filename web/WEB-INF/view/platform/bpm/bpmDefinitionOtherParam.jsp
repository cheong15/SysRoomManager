			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>流程启动后直接完成第一个节点的任务。</span></a></div>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>不使用表单直接启动流程，启动流程时不传入主键。</span></a></div>
					</td>	
				</tr>
				</c:if>
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选，那么流程启动时可以改变下一步的执行人，默认不可以。</span></a></div>
					</td>	
				</tr>
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选，那么流程执行时会转向设置的url业务表单上去。</span></a></div>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选,在每一次提交提示确认对话框，默认关闭。</span></a></div>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选,则允许转办，默认不允许转办。</span></a></div>
					</td>	
				</tr>
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选，则允许转发，默认不允许。</span></a></div>
					</td>	
				</tr>
				<tr>
					<th width="20%">归档时发送消息给发起人:</th>
					<td>
							<label><input type="checkbox" name="informStart" value="3" <c:if test="${fn:contains(bpmDefinition.informStart,3)}">checked="checked"</c:if>/>站内消息</label>
							<label><input type="checkbox" name="informStart" value="1" <c:if test="${fn:contains(bpmDefinition.informStart,1)}">checked="checked"</c:if>/>邮件</label>
							<label><input type="checkbox" name="informStart" value="2" <c:if test="${fn:contains(bpmDefinition.informStart,2)}">checked="checked"</c:if>/>手机短信</label>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果勾选，则流程实例归档后将提供打印表单功能。</span></a></div>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>流程帮助附件</span></a></div>
					</td>	
				</tr>
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>维护该流程可以进行引用的流程。</span></a></div>
					</td>	
				</tr>
				<tr>
					<th width="20%">流程参考:</th>
				...
				<tr>
					...
					<td>
						...
						<span id="spanMessage" <c:if test="${bpmDefinition.status==2||bpmDefinition.status==3}">style="display:none;"</c:if>>
							<label><input type="checkbox" name="informType" value="3" <c:if test="${fn:contains(bpmDefinition.informType,3)}">checked="checked"</c:if>/>站内消息</label>
							<label><input type="checkbox" name="informType" value="1" <c:if test="${fn:contains(bpmDefinition.informType,1)}">checked="checked"</c:if>/>邮件</label>
							<label><input type="checkbox" name="informType" value="2" <c:if test="${fn:contains(bpmDefinition.informType,2)}">checked="checked"</c:if>/>手机短信</label>
						</span>
				...
				<tr>
					...
					<td>
						...
						<div class="tipbox"><a href="#" class="tipinfo"><span>如果相邻的任务节点执行人相同时,直接跳过。</span></a></div>
					</td>	
				</tr>
			</table>
			</div>

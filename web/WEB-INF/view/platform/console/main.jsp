    ...
    <script type="text/javascript">
            ...
            $(function (){
                ...
                $("#menuPanel").delegate("a.menuItem", "click", function(){
                    ...
                    $("#leftTree").find('li:eq(0)').find('a').click();
                });
        		...
        		//parent.addToTab("${ctx}/nghrp/sm/home/chart.ht", "我的标签", "${myFlagResId}", "");
...
<div id="pageloading"></div>
  ...
  <div id="layoutMain" style="width:99.2%; margin:0 auto; margin-top:4px;">
        <div position="left" id="accordion1"  title="<img src='${ctx}/styles/default/images/icon/home.png' >  ${currentSystem.sysName }"> 

		...
		<div class="panel-body">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${outMailUserSeting.SSL==1}">是</c:when>
							<c:otherwise>否</c:otherwise>
						</c:choose>
					</td>
				</tr>
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${outMailUserSeting.validate==1}">是</c:when>
							<c:otherwise>否</c:otherwise>
						</c:choose>
					</td>
				</tr>
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${outMailUserSeting.isHandleAttach==1}">是</c:when>
							<c:otherwise>否</c:otherwise>
						</c:choose>
					</td>
				</tr>
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${outMailUserSeting.isDeleteRemote==1}">是</c:when>
							<c:otherwise>否</c:otherwise>
						</c:choose>
					</td>
				</tr>

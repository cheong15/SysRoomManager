...
//				sb.append("<td style='text-align:center;'>&nbsp;</td>");
//			}
			sb.append("<td>" +((field.isDeleted==0)?"<a href='#"+field.fieldName+"' name='editColumn'  >"+$lang.button.edit+"</a>":" ")+"</td>");
			sb.append("</tr>");
		}
		return sb.toString();
	};
...
//				sb.append("<td style='text-align:center;'>&nbsp;</td>");
//			}
			sb.append("<td>" +((field.isDeleted==0)?"<a href='#' name='editColumn'  >"+$lang.button.edit+"</a>":" ")+"</td>");
			sb.append("</tr>");
		}
		return $(sb.toString());
	};
...
TableRow.del=function(){
	...
	if(objTr.length==0) {
		$.ligerDialog.warn($lang_form.fieldManage.notCheckedRow,$lang.tip.msg);
		return;
	};
	var fieldName=objTr.attr("fieldName");
	var field=TableRow.fieldManage.getFieldByName(fieldName);
	if(field.isRequired){
		$.ligerDialog.warn($lang_form.fieldManage.isRequired,$lang.tip.msg);
		return;
	}

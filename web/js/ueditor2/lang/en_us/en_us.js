...
UE.I18N['en_us'] = {
    'labelMap':{
        ...
        'unlink':'Unlink', 'insertrow':'InsertRow', 'insertcol':'InsertCol','insertrownext':'InsertRowNext','insertcolnext':'InsertColNext', 'mergeright':'MergeRight', 'mergedown':'MergeDown',
        ...
        'webapp':'WebAPP', 'touppercase':'UpperCase', 'tolowercase':'LowerCase','template':'Template','background':'Background','inserttable':'InsertTable','music':'Music',
    	'tableformat':'Cell Style Brush','choosetemplate':'Rechoose Template','input':'Custom Button','opinion':'Opinion','taskopinion':'Approval History',
        'flowchart':'Process Sketch Map','insertfunction':'Statistical Function','cutsubtable':'Cut The Subtable','pastesubtable':'Paste The Subtable','customdialog':'Custom Dialog',
        'customquery':'Linkage Setting','uncustomquery':'Delete Linkage Setting','numbervalidate':'Validate Number Value Range','international':'International','serialnum':'Insert serial number',
        'hidedomain': 'Hidden Field', 'textinput': 'single line of text', 'textarea': 'multi-line text', 'checkbox': 'checkbox', 'radioinput': 'radio button', 'selectinput ':'drop-down box',
        'dictionary': 'Data Dictionary', 'personpicker': 'People Picker', 'departmentpicker': 'Sector Selector', 'datepicker': 'date controls', 'officecontrol': 'office control', 'subtable' : 'child table',
        'ckeditor': 'ckeditor', 'rolepicker': 'Role Selector', 'positionpicker': 'positions selector', 'attachement': 'attachment', 'importform': 'Import Form', 'exportform' : 'export Form','pasteinput':'Paste Field','websigncontrol':'webSign',
        'pictureshowcontrol':'pictureShow','cascadequery':'Cascade Setting','uncascadequery':'Delete Cascade Setting'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    'opinion':{
    	'static':{
    		'lang_box_prop':'Opinions Box Properties',
    		'lang_form_name':'Form Name',
    		'lang_opinion_name':'Opinion Name',
    		'lang_control_width':'Width Of The Control',
    		'lang_control_height':'Height Of The Control'
    	},
    	'msg_form_field':'Form name field can only letters and underlined',
    	'msg_opinion_exist':'Opinion form name already exists'
    },
    'customdialog':{
    	'static':{
    		'lang_dialog_setting':'Dialog Setting',
    		'lang_choose_dialog':'Choose',
    		'lang_return_setting':'Return Value Setting',
    		'dialog-type':{options:['--Please Select--']}
    	},
    	'self':'Custom Dialog',
    	'main':'Main Table',
    	'sub':'Sub Table'
    ...
    'insertfunction':{
    	'static':{
    		'lang_math_prop':'Function Property',
    		'lang_math_type':'Function Type',
    		'lang_all_field':'All Fields',
    		'lang_count_field':'Statistics Field',
    		'lang_input_readonly':'Input Readonly',
    		'lang_dis_rmb':'Show As RMB Capital',
    		'lang_dis_span':'Show As Span',
    		'lang_dis_persent':'Show As Percentage',
    		'lang_num_tofixed':'Decimal places',
    		'lang_num_bit':''
    	},
    	'msg_not_num':'Selected field is not numeric types'
    },
    'input':{
    	'static':{
	    	'lang_button_prop':'Button Property',
	    	'lang_button_label':'Label',
			'lang_button_img':'Button Icon',
			'lang_choose_img':'Choose Icon'
    	}
    },
    'customquery':{
    	'static':{
    		'lang_search_setting':'Search Setting',
    		'lang_choose_search':'Choose Search',
    		'lang_condition_field':'Condition Field',
    		'lang_trigger_event':'Trigger Event',
    		'lang_return_setting':'Return Value Setting',
    		'dialog-type':{options:['--Please Select--']},
    		'bind-event':{options:['Enter','Value Changed']}
    	}
    },
    'numbervalidate':{
    	'static':{
    		'lang_num_range':'Validate Number Value Range',
    		'lang_less_equal':'Less than Or Equal',
    		'lang_more_equal':'More than Or Equal'
    	}
    },
    'international':{
    	'static':{
    		'lang_dialog_setting':'Set internationalization resources'
    	}
    },
    ...
    'cascadequery':{
    	'static':{
    		...
    		'lang_choose_search':'Choose Search',
    		'lang_condition_field':'Condition Field',
    		'lang_trigger_event':' Cascade Of The Parent',
    		'lang_parent_type':'Type Of The Parent',
    		'lang_parent_value':'Value Of The Parent',
    		'lang_search_again':'Search By Key ',
    		'lang_return_setting':' Value ',
    		'dialog-type':{options:['--Please Select--']},
    		'bind-event':{options:['--Please Select--']}
    	}
    }
};
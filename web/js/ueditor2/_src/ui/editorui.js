...
(function () {
    ...
    var extendConf = baidu.editor.ExtendConf;
    editorui.buttons={};
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','websigncontrol','pictureshowcontrol'].concat(extendConf.btnCmds);
    ...
    //③扩展
    dialogBtns.ok = dialogBtns.ok.concat(extendConf.dialogBtns);
    //④扩展
    utils.extend(editorui,extendConf.methods);

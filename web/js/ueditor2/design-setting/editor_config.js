       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'ckeditor','rolepicker','positionpicker','attachement','websigncontrol','importform','exportform',
                '|','pasteinput','tableformat','choosetemplate','opinion','input','|','taskopinion','flowchart',
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','numbervalidate','pictureshowcontrol','help']
        ]

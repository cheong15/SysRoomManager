var $lang_bpm = {
	...
	bpmDefinition : {
		...
		nodeSet : {
			...
			userSet : 'Staffing',
			flowForkJoin : 'Flow Distribution Summary',
			webServiceSet : 'WebService settings',
	...
	nodeButton : {
		...
		delTip : 'OK Clear definition of the process all the buttons do? ',
	...
	task : {
		...
		toStart : {
			...
			warn_msg_form_validate : "Please check whether the form is filled out correctly!",
		...
		startFlowForm : {
			...
			warn_msg_form_validate : "Please check whether the data fill in the form correctly!",
			warn_msg_form_subtable_require : "There must be a child table records, check!",

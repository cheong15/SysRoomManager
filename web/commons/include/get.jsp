...
<script type="text/javascript" src="${ctx}/js/lg/ligerui.all.js"></script>
<script type="text/javascript" src="${ctx}/js/hotent/displaytag.js" ></script>
<script type="text/javascript" src="${ctx}/js/lg/plugins/ligerDialog.js" ></script>
<script type="text/javascript" src="${ctx}/js/util/handleForm.js"></script>
<script type="text/javascript" src="${ctx}/js/util/shelter.js"></script>
